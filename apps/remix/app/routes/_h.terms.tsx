  ...
  return (
    <div className="mx-10 mt-24 text-white">
      <div className="max-w-[1400px] ">
        ...
        <p className="mt-8">
          Welcome to FBMAIL.CC! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          FBMAIL.CC is a minimalistic temporary email service that allows you to
          ...
          FBMAIL.CC operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that FBMAIL.CC is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to FBMAIL.CC and its services
          belong to FBMAIL.CC. You may not copy, reproduce, distribute, modify,
          or create derivative works of FBMAIL.CC or any part thereof without
          explicit permission from FBMAIL.CC.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use FBMAIL.CC. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using FBMAIL.CC, you agree not to
        ...
        <p className="mt-4">
          FBMAIL.CC is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of FBMAIL.CC is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall FBMAIL.CC or
          ...
          from your access to or use of FBMAIL.CC or any content or services
          provided through FBMAIL.CC.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of FBMAIL.CC after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where FBMAIL.CC is located. Any disputes
